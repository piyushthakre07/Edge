...
@NamedQueries({ @NamedQuery(name = "findAllProduct", query = "from ProductMaster"),
@NamedQuery(name = "findProductById", query = "from ProductMaster where productId=:productId"), })
